        ...
        while not self.otp:
            ...
            if self.otp:
                ...
                if res.status_code == 400:
                    print("[*] 𝓪𝓬𝓮𝓼𝓼𝓲𝓷𝓰 𝓸𝓽𝓹 𝓪𝓰𝓪𝓲𝓷!!") if self.mode == "a" else print(
                        "𝔂𝓸𝓾 𝓱𝓪𝓿𝓮 𝓰𝓲𝓿𝓮𝓷 𝓪 𝔀𝓻𝓸𝓷𝓰 𝓸𝓽𝓹!!.."
                    )
                    self.otp = None
                else:
        ...
        try:
            ...
            if res.status_code != 200:
                if res.status_code == 204:
                    print(
                        "[*] 𝖘𝖊𝖗𝖛𝖊𝖗 𝖒𝖎𝖌𝖍𝖙 𝖍𝖆𝖛𝖘𝖊𝖗𝖛𝖊𝖗 𝖒𝖎𝖌𝖍𝖙 𝖍𝖆𝖛𝖊 𝖉𝖊𝖙𝖊𝖈𝖙𝖊𝖉 𝖇𝖔𝖙 𝖆𝖈𝖙𝖎𝖛𝖎𝖙𝖞.. 𝖘𝖑𝖊𝖊𝖕𝖎𝖓𝖌 𝖋𝖔𝖗 յշօ 𝖘𝖊𝖈𝖔𝖓𝖉𝖘𝖊 𝖉𝖊𝖙𝖊𝖈𝖙𝖊𝖉 𝖇𝖔𝖙 𝖆𝖈𝖙𝖎𝖛𝖎𝖙𝖞.. 𝖘𝖑𝖊𝖊𝖕𝖎𝖓𝖌 𝖋𝖔𝖗 յշօ 𝖘𝖊𝖈𝖔𝖓𝖉𝖘"
                    )
                    time.sleep(120)
                    print("[*] 𝖙𝖗𝖞𝖎𝖓𝖌 𝖆𝖌𝖆𝖎𝖓 ...")
...
#                 input()
        ...
        if not final_list:
            print(
                "[-] 𝕒𝕝𝕝 𝕓𝕖𝕟𝕖𝕗𝕚𝕔𝕚𝕒𝕣𝕚𝕤 𝕒𝕣𝕖 𝕧𝕒𝕔𝕔𝕚𝕟𝕒𝕥𝕖𝕕(𝕓𝕠𝕠𝕜𝕖𝕕) 𝕠𝕣 𝕟𝕠 𝕤𝕝𝕠𝕥𝕤 𝕒𝕧𝕒𝕚𝕝𝕒𝕓𝕝𝕖 𝕟𝕠𝕨.."
            )
            return
...
def getDistrictId(
    ...
    try:
        ...
        print(
            "[+] 𝓋𝒶𝒸𝒸𝒾𝓃𝒶𝓉𝒾𝑜𝓃 𝒸𝑒𝓃𝓉𝑒𝓇𝓈 𝓃𝑒𝒶𝓇 𝓎𝑜𝓊 𝒶𝓇𝑒 ::\n"
